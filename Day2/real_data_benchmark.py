...
def sum_invalid_ids_with_function(
    id_range: tuple[int, int], invalid_func: Callable[[int], bool]
) -> int:
...
def benchmark_with_real_data(
    filename: str, function_name: str, invalid_func: Callable[[int], bool]
) -> tuple[float, int]:
...
def main():
    ...
    print("\n--- TEST INPUT ---")
    test_orig_time, test_orig_sum = benchmark_with_real_data(
        "test_input.txt", "Original", is_invalid_id_original
    )
    test_opt_time, test_opt_sum = benchmark_with_real_data(
        "test_input.txt", "Optimized", is_invalid_id_optimized
    )
    ...
    print("\n--- FULL INPUT ---")
    orig_time, orig_sum = benchmark_with_real_data(
        "input.txt", "Original", is_invalid_id_original
    )
    opt_time, opt_sum = benchmark_with_real_data(
        "input.txt", "Optimized", is_invalid_id_optimized
    )
